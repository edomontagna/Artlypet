...
function RegisterForm() {
  ...
  const { signUpWithEmail, signInWithGoogle, signInWithApple } = useSupabaseAuth();
      ...
      <div className="min-h-screen flex items-center justify-center px-4 pt-20">
        ...
        >
          <motion.div
            ...
            className="mx-auto w-20 h-20 rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/30"
          >
            <Sparkles className="w-10 h-10 text-white" />
          </motion.div>
          <h2 className="text-3xl font-bold text-white mb-3">Check Your Email!</h2>
          <p className="text-gray-400 mb-8">
            We&apos;ve sent a confirmation link to <span className="text-white font-medium">{email}</span>. Click the link to activate your account and start creating.
          </p>
      ...
      >
        <Card className="relative overflow-hidden">
          ...
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Get 3 free creations every month</CardDescription>

            {refCode && (
              <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-medium"
              >
                <Gift className="w-3.5 h-3.5" />
                Referred by a friend &mdash; bonus credits!
              </motion.div>
            )}
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button variant="secondary" onClick={() => signInWithApple()} className="w-full">
